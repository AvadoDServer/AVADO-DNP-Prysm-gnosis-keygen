            ...
            <section className="keygen is-medium has-text-white">
                <div className="columns is-mobile">
                    <div className="column is-8-desktop is-10">
                        ...
                        <h1 className="title is-1 is-spaced has-text-white">Gnosis Staking Key Generator</h1>
                        <p>This package allows you to generate staking keys for GBC on your local machine.</p>
                        <br />
                        <div className="columns">
                            <div className="column is-half ">
                                ...
                                <p>
                                    ...
                                    you can later use to deposit on the GBC deposit site & use these keys in the AVADO Gnosis Prysm client (or other clients)
                        </p><br />
                                <p>This is just a little more user friendly, and true to the AVADO spirit of making everything as easy as possible !</p>
                                <br />
                                <p>NOTE: After generating and downloading the keys - you can remove this package again. It is not required to run your validator. It is just a tool to easily generate Gnosis validator keys.</p>

                            </div>
                            <div className="column is-half">
                                <img src={gnosis} alt="Gnosis logo" />
                                {/* <p className="has-text-centered help">Leslie the Launchpad gnosis (<a target="_blank" href="https://launchpad.ethereum.org/">source</a>)</p> */}
                            </div>
                        </div>
                        {!cmdOutput && (
                            <>
                            ...
                            (
                                <>
                                    ...
                                    <ul>
                                            ...
                                            <li>Your deposit file you can use on the <a target="_blank" href="https://deposit.gnosischain.com/">Gnosis Beacon Chain Deposit website</a> to fund the validator account(s)</li>
